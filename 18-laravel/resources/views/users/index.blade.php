                ...
                <table class="table table-xs bg-[#0006]">
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <th>
                                <a href="{{ url('users/'.$user->id) }}" class="btn btn-ghost hover:bg-[transparent] btn-xs">
                                ...
                                <a href="{{ url('users/'.$user->id.'/edit') }}" class="btn btn-ghost hover:bg-[transparent] btn-xs">
